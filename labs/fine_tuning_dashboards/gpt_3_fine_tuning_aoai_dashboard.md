...
Learn how to fine-tune a GPT-3 model using Azure OpenAI Studio - UI Dashboard.  
...
The first step in creating a custom model is to choose a base model. In this demo, we choose *gpt-35-turbo-0613*.
